...
import static util.Utils.preOrderPrintTreeNodeAndChildren;
...
public class MaxHeap {
    ...
    public void insert(int newValue) {
        ...
        while (buffer[pointer] > buffer[parentPoint]) {
            swap(pointer, parentPoint, buffer);
            pointer = parentPoint;
    ...
    public void heapify(int index) {
        ...
        while (leftChild < heapSize) {
            ...
            swap(index, indexOfLargest, buffer);
...
//        checkBasicOperations(maxHeap);
        ...
        int[] testData = generateTestData(1000000, 0, 100000);
        ...
        compareArray(copiedArray, maxHeap.getHeapArray());
    }

    private static MaxHeap checkBasicOperations(MaxHeap maxHeap) {
        int[] testData = generateTestData(15, 0, 100);
        print(testData);
